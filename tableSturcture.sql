...
--MySQL ExamMarks data table View 1

mysql> select * from ExamMarks;
+-------+-------+-------+--------------+-----------+--------------+-----------+------------+--------------+----------+-------+
| Quiz1 | Quiz2 | Quiz3 | MidPractical | MidTheory | EndPractical | EndTheory | Assesments | stuID        | courseID | DepID |
+-------+-------+-------+--------------+-----------+--------------+-----------+------------+--------------+----------+-------+
...
--MySQL ExamMarks data table View 2
